...
docker container rm prime-app prime-app
...
docker run -v E:\dev\git\Primes\web-app\dist\:/var/www/localhost/htdocs -dp 80:80 registry.gitlab.com/s.teumert/docker-lighttpd